...
int main() {
    vector<string> testcases = { " abc + a'b'c","A+Y'+c'"," abc + a'b'c"," (a+b+c)"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c"," abc + a'b'c" };
    string s1;
    for (int i = 0; i < 10; i++) {
        cout << "--------------" << endl;
        ...
        for (int i = 0; i < pow(2, numOfVar); i++) {
            ...
            v1[numOfVar-1] = evaluatePrefix(tempPrefix); // store the Value of my Function in the last bit of my vector 
            tt.push_back(v1);
        }
        cout << "hi";
